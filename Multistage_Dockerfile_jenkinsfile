...
steps{
sh "docker build -f Multistage_Dockerfile -t mallegowda/maven:${BUILD_NUMBER} ."
}
}
...
steps{
withCredentials([string(credentialsId: '426a9565-fdd5-4143-ae4c-87b417b22970', variable: 'dockerhub')]) {
